    ...
    return dmc.MantineProvider(
        ...
        theme={
            ...
            "colors": {
                ...
                # App accent (primaryColor = "brand"): blue ramp anchored so shade
                # 6 == rgb(51,153,255) == #3399ff (primaryShade light=6, dark=8).
                "brand": [
                    "#e7f3ff",
                    "#cae4ff",
                    "#a9d4ff",
        ...
        children=[
            # a11y: first tab stop jumps past the ~57 nav stops straight to the page
            # content (visible only on keyboard focus — .skip-link in assets/main.css)
